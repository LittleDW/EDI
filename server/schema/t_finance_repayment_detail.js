...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('t_finance_repayment_detail', {
    id: {
    ...
    tableName: 't_finance_repayment_detail',
    chineseTableName:"还款对账单明细表",
    chineseFieldName: {
      id: "ID",
      ...
      repayment_date: "还款日期",
      current_period: "当前期次",
      repayment_principal_fee: "应还本金",
      repayment_interest_fee: "应还利息",
      repayment_all_fee: "应还总额",
      remark: "备注",
