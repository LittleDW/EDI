...
} = require('../../services').business.financeRepayment;
...
const matchDetail = async (req, res, next) => {
  ...
  let resultData = await matcher(path.resolve(`${__dirname}/../../spawn/financeRepaymentMatcher.js`), param, req.files)
