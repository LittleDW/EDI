...
class CreateAssetOrder extends Component {
  constructor(props) {
    ...
    this.tableColumns = [
      ...
      { text: '借款人营业执照号', name: 'borrow_business_license' },
     ...
     /* { text: '借款人证件号', name: 'borrow_certificate_no' },
      ...
      /*
      { text: '借款人授信额度（单位：分）', name: 'borrow_credit_fee' },
      { text: '借款人征信报告情况', name: 'borrow_credit_report' },
      { text: '借款人收入及负债情况', name: 'borrow_income_report' },*/
  ...
  handleCreateAssetOrder(e) {
    ...
    let runner = ()=>{
      if(attachment && orders.length){
        ...
        let api = createAssetOrder(formData,{onProgress: self.handleProgress/*,socket:self.handleAPIProgress*/})
        self.xhr = api.xhr
        api.promise.then(()=>{
  ...
  renderHint(){
    ...
    return (<span className={`col-sm-4 text-danger ${style["legend-value"]}`}>
      {message}
      ...
      <div className="component">
        <div className="wrapper__no-filter-form__expand container-fluid">
          {progress && <div className="progress edi_progress">
            <div className={`progress-bar edi_progress-bar progress-bar-striped active`} style={{width:progress.percent}}></div>
          ...
          <section className="section__handleOrder-960">
            <form onSubmit={this.handleMatchAssetOrder} className="form-horizontal">
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-6">
                  <a target="_blank" href="/企业订单信息表模板.xlsx"  styleName="label-value">下载模板</a>
