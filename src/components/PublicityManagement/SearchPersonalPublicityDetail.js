...
class SearchPublicityDetail extends Component {
  constructor(props) {
    ...
    this.xhr = null
    this.columns = [
      { text: '姓名', name: 'borrow_name' },
      { text: '身份证号', name: 'borrow_certificate_no' },
      { text: '手机', name: 'borrow_phone' },
      { text: '银行卡号', name: 'borrow_card_no' },
          ...
          <section className="section__handleOrder-960">
            <form onSubmit={this.handleMatchAssetOrder} className="form-horizontal">
              <h3 className="form-group">
                <span className="col-sm-3 text-right">个人征信信息查询</span>
                {this.renderHint()}
              </h3>
              <hr />
              <div className="form-group row">
                ...
                <div className="col-sm-6">
                  <span styleName="label-value">个人</span>
                </div>
              </div>
              <div className="form-group row">
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-6">
                  <a target="_blank" href="/个人征信信息查询模板.xlsx" styleName="label-value">下载模板</a>
